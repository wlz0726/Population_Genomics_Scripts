...
#print $fh qq(set title "$title_str";); # the title line
  ...
  print $fh qq(
  set yran [0:$yran];
  set y2label "Stacked Loess Magnetic Susceptibility (normalized)" ;
  set y2ran [0:$AADD];
  set y2tics 
  ...
  set out "$prefix.eps";
  set style line 1 lt 1 lc rgb "red3" $lw;
  set style line 2 lt 2 lc rgb "#B8860B" $lw;
  set style line 3 lt 3 lc rgb "#458B74" $lw;
  set style line 4 lt 4 lc rgb "#0000FF" $lw;
  set style line 5 lt 5 lc rgb "#00008B" $lw;
  set style line 6 lt 6 lc rgb "#8A2BE2" $lw;
  set style line 7 lt 7 lc rgb "#A52A2A" $lw;
  set style line 8 lt 8 lc rgb "#FF4040" $lw;
  set style line 9 lt 9 lc rgb "#8B7355" $lw;
  set style line 10 lt 10 lc rgb "#7FFF00" $lw;
  set style line 11 lt 11 lc rgb "#458B00" $lw;
  set style line 12 lt 12 lc rgb "#D2691E" $lw;
  set style line 13 lt 13 lc rgb "#FF7256" $lw;
  set style line 14 lt 14 lc rgb "#8B0000" $lw;
