...
#my @population=("African","Agarli","American","Canadensis","Europe","Iran","Kazakh","Mongolia","Morocco","South_Asian","Tibetan","Urial","Yunnan");

my %h;
#foreach my $k1(sort @population){
#    foreach my $k2(sort @population){
#	$h{$k1}{$k2}=0;
#    }
#}
my @in=<01.VCF/*match>;
...
#my @pop=("Aga","Can","Uri","Afr","Eur","Ame","Mor","Ira","Kaz","Sou","Mon","Tib","Yun");
my @pop=("Afr","Eur","Ame","Mor","Ira","Kaz","Sou","Mon","Tib","Yun");
