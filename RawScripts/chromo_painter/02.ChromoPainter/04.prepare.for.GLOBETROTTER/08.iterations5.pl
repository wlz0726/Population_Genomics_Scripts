...
print O2 "export R_LIBS=/home/wanglizhong/R:/ifshk5/PC_HUMAN_EU/USER/wanglizhong/R:\$R_LIBS;/ifshk4/BC_PUB/biosoft/PIPE_RD/Package/R-3.1.1/bin/R < /ifshk5/PC_HUMAN_EU/USER/wanglizhong/software/chromopainter/GLOBETROTTER2/GLOBETROTTER.R $0.$pop.paramfile 03.Second.Run.pl.out.pick.samplesfile.txt 03.Second.Run.pl.out.pick.recomfile.txt --no-save > $0.$pop.log;\n";
}
close O1;
close O2;
