...
#    my $real_time            = $left_time/($opts{u}/2)*$opts{g};
...
#my $gunbin="/usr/bin/gnuplot";
my $gunbin='/home/wanglizhong/software/gnuplot/gnuplot-4.6.6/bin/gnuplot';
...
#  set out "$prefix.eps";
	       ...
	       set style line 12 lt 1 lc rgb "#FFC127" lw 4;
               set style line 13 lt 1 lc rgb "#D2691E" lw 4;
               set style line 14 lt 1 lc rgb "#FF7256" lw 4;
               set style line 15 lt 1 lc rgb "#8B0000" lw 4;
